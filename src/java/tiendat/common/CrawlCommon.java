...
public class CrawlCommon {
    ...
    public static final String PATH_STYLESHEET = "WEB-INF/stylesheet/";
    public static final String PATH_XML = "WEB-INF/document/";
    public static final String PATH_XML_OUTPUT = "WEB-INF/classes/tiendat/fileOutput/";
    ...
    public static final String XSL_TONGKHO_NHACCU = "WEB-INF/xsl/tongkhonhaccu.xsl";

    //URL
    public static final String URL_GUITAR_STATION = "https://guitar.station.vn";
    public static final String URL_GUITAR_DUY = "https://guitartphcm.com";
    ...
    public static final String URL_TONGKHO_NHACCU = "https://tongkhonhaccu.com";
